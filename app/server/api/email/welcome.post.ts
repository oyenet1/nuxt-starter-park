...
export default defineEventHandler(async (event) => {
  ...
  const html = `
    ...
    <head>
      <meta charset="utf-8">
      <title>Welcome to SupaNuxt</title>
      <style>
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to SupaNuxt!</h1>
        </div>
        <div class="content">
          <p>Hi ${name || "there"},</p>
          <p>Thank you for registering with SupaNuxt. We're excited to have you on board!</p>
